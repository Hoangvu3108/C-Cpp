...

{
    ...
    sv1.ten="Hoang Van A";
    sv1.id=20217599; // ID không được phép thay đổi từ bên ngoài lớp nhưng khi khởi tạo thì ID sẽ tự động tăng lên 1
...
// Public: là thuộc tính có thể truy cập từ bên ngoài lớp lẫn cả bên trong, còn private: là thuộc tính không thể truy cập từ bên ngoài lớp.
// sử dụng contructor để khởi tạo các thuộc tính của lớp bên trong hàm khởi tạo